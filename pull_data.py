...
col_names = ['Date', 'Country', 'State', 'fips', 
       ...
       'Number of Vaccines Distributed', 'Number of Vaccinations Initiated',
       'Number of Vaccinations Completed', 'Test Positivity Ratio',
        'Case Density',
       'Contact Tracer Capacity Ratio', 'Infection Rate',
       'Infection Rate CI90', 
       'ICU Capacity Ratio', 'Risk Levels Overall',
       'Vaccinations Initiated Ratio',
       'Vaccinations Completed Ratio', 'Number of New Deaths',
       'Number of Vaccines Administered', 'Risk Levels - Case Density',
